...
OpenRewrite enables large-scale **distributed** source code refactoring for framework migrations, vulnerability patches, and API migrations with an early focus on the **Java** _language_.
